...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SearchService.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SearchService.Domain.Entities.SearchHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("SearchService.Domain.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("SearchService.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SearchService.Domain.Entities.SearchHistory", b =>
                {
                    b.HasOne("SearchService.Domain.Entities.User", "SearchByUser")
                        .WithOne()
