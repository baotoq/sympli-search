...
namespace SympliSearch.MigrationService.Migrations
{
    ...
    [Migration("20250110051805_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SympliSearch.ApiService.Domain.Entities.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("SympliSearch.ApiService.Domain.Entities.CartItem", b =>
                {
            ...
            modelBuilder.Entity("SympliSearch.ApiService.Domain.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("SympliSearch.ApiService.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SympliSearch.ApiService.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("SympliSearch.ApiService.Domain.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("SympliSearch.ApiService.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SympliSearch.ApiService.Domain.Entities.CartItem", b =>
                {
                    b.HasOne("SympliSearch.ApiService.Domain.Entities.Cart", "Cart")
                        .WithMany("CartItems")
                    ...
                    b.HasOne("SympliSearch.ApiService.Domain.Entities.Product", "Product")
                        .WithMany("CartItems")
